...
class CartItem(models.Model):
    ...
    products = models.ForeignKey(Product,on_delete='CASCADE', blank=True,null=True)
    quantity=models.PositiveIntegerField(default=1)
    linetotal = models.DecimalField(default=10.99, max_digits=100, decimal_places=2)
    objects = CartManager()
